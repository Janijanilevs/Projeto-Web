...
$medicos =[
    ...
    [
        "nome" => "Fábio de Oliveira",
        "especialidade" => "Cardiologia",
        "foto" => "https://i.pinimg.com/564x/e2/56/f2/e256f28fb227248309d94f68a629bcfc.jpg",
        "formação" => "Formado em medicina pela UFBA, com mais de 15 anos trabalhando na área, ele é especializado em cardiologia infantil, checando os batimentos do seu pequeno."   
    ],

    [
        "nome" => "João Valadares",
        "especialidade" => "Cardiologia",
        "foto" => "https://i.pinimg.com/564x/95/28/67/952867678246dd51b3fa7663bec27aea.jpg",
        "formação" => "Formado em medicina pela UFMG, com mais de 20 anos trabalhando na área, e sendo sua especialidade um tratamento intensivo, voltado para fazer a sua cirurgia. "   
    ],
    [
        "nome" => "Ana Maria",
        "especialidade" => "Cardiologia",
        "foto" => "https://i.pinimg.com/564x/a4/0b/b5/a40bb56caa09bc24c3ece9662ebc9593.jpg",
        "formação" => "Formada em medicina pela USP, com mais de 8 anos trabalhando na área, ela vai te ajudar a se recuperar de lesões, especializada no ramo da Ergometria e reabilitação, propõe com sua didática um melhor condicionamento do coração."   
    ],

    [
        "nome" => "Leviatan Ubirajara",
        "especialidade" => "Cardiologia",
        "foto" => "https://i.pinimg.com/564x/7d/6c/37/7d6c37451113490accea2dca24dc442d.jpg",
        "formação" => "Formado em medicina pela USP, com mais de 50 anos trabalhando na área, um renomado médico no setor intensivista, focado no estudo sobre arritimias Eletrofisiologia Cardíaca."   
    ],
/*-----------------------Parte dos Cirurgiões Plásticos-------------------------------------------------------------------------------*/
      [
        "nome" => "Milton Ricardo",
        "especialidade" => "Cirurgia Plástica",
        "foto" => "https://i.pinimg.com/originals/3d/c8/f2/3dc8f2c8fa0a30baef024dcf00cc3f37.jpg",
        "formação" => "Formado em medicina pela UNIFG,especializado em implantes de silicone, mamoplastia, abdominoplastia e lipo HD, com mais de 10 anos transformando vidas."
      ...
      [
        ...
        "especialidade" => "Cirurgia Plástica",
        "foto" => "https://i.pinimg.com/564x/2e/59/80/2e5980b48418fa8ce49c64bf6e66186f.jpg",
        "formação" => "Formado em medicina pela UNICAMP,com formação para cuidados com queimaduras, de 1º, 2º, 3º grau, para minimizar os efeitos em sua pele."
      ],

      [
        "nome" => "Eloah Luz",
        "especialidade" => "Cirurgia Plástica",
        "foto" => "https://i.pinimg.com/564x/e9/a6/01/e9a601c37cc6f0f1e08e8c9204ac7e41.jpg",
        "formação" => "Formada em medicina pela UNB, e com especialidade em cosmiatria, cuidando para retardar o envelhecimento de sua pele."
      ],

      [
        "nome" => "Murilo Bittencourt",
        "especialidade" => "Cirurgia Plástica",
        "foto" => "https://i.pinimg.com/564x/3b/09/84/3b098458469a2e6b805da7f078f45ba6.jpg",
        "formação" => "Formada em medicina pela UFF, e com especialidade em plástica pediatra, cuidando de situações de má formações e situações com crianças."
      ],
      /*-----------------------Parte dos Nutricionistas-------------------------------------------------------------------------------*/

      [
        "nome" => "Layana Vasconcelos",
        "especialidade" => "Nutrição",
        "foto" => "https://i.pinimg.com/564x/21/16/8a/21168a07c442ee1c223ce9c4a7cbdaf7.jpg",
        "formação" => "Formada em nutrição pela UFRB, com sua especialidade nutrição clínica, com receituários para uma boa dieta."
      ],

      [
        "nome" => "Adalberto Moreira",
        "especialidade" => "Nutrição",
        "foto" => "https://img.freepik.com/fotos-gratis/retrato-do-doutor-bonito-com-casaco-azul-olhando-para-a-camera_171337-15911.jpg?w=1060&t=st=1684462215~exp=1684462815~hmac=6f96ebb739d004f72245ad97460737b20d03302fd2018799887b12eae6d4034f",
        "formação" => "Formada em nutrição pela UFRN, com sua especialidade nutrição do esporte, conciliando uma rotina intensa de 1 atleta com uma alimentação balanceada."
      ],

      [
        "nome" => "Jonathan Ribeiro",
        "especialidade" => "Nutrição",
        "foto" => "https://i.pinimg.com/736x/4b/ea/99/4bea99eb80bbd65cce12c9bc66717d02.jpg",
      ...
      [
        "nome" => "Manuela Santos",
        "especialidade" => "Nutrição",
        "foto" => "https://i.pinimg.com/564x/6d/3b/a9/6d3ba905d73028c0f98e0a419cf5ecaa.jpg",
        "formação" => "Formada em nutrição pela UFPB, com sua especialidade em segurança dos alimentos, proporcionando uma maior qualidade de consumo de alimentos."
      ],
...
/*----------------------------Parte dos Ginecologistas-------------------------------------------------------------------------------*/
     ...
     [
      ...
      "foto" => "https://i.pinimg.com/564x/35/5b/52/355b524b3c913230f06d36840976b3c9.jpg",
      "formação" => "Formada em odontologia pela UFRJ, com sua especialidade Endodontia, tratando de enfermidades da polpa e da raiz do dente."
    ],

    [
      "nome" => "Murilo Araujo",
      "especialidade" => "Odontologia",
      "foto" => "https://i.pinimg.com/564x/c1/f9/0a/c1f90acdb98132d9e63938e6c63ada7b.jpg",
    ...
    [
      "nome" => "Victor Correia ",
      "especialidade" => "Odontologia",
      "foto" => "https://i.pinimg.com/564x/27/44/2b/27442b1b978a94dac99a643ffad99438.jpg",
      "formação" => "Formado em odontologia pela UESB, com sua especialidade Ortodontia, sua especialidade permite tratar com cuidado a posição dos dentes, e dos ossos maxilares."
    ],
